...
Source for [docs.fixyourdocs.io](https://docs.fixyourdocs.io). The block below is the canonical [Docs Feedback Protocol](https://docsfeedback.org) AGENTS.md block, dogfooded here like every other FixYourDocs repo.
