...
```sh
npx @fixyourdocs/sdk init      # add the AGENTS.md block
npx @fixyourdocs/sdk report …  # send a report
```

Ships with [`@fixyourdocs/sdk`](/v0.1/sdk/typescript/).
...
Ships with the [`fixyourdocs`](/v0.1/sdk/python/) Python package.
...
Adds the canonical [Docs Feedback Protocol](/v0.1/protocol/) block to your
...
[AGENTS.md snippet](/v0.1/agents-md/) page — there's no other state to
configure.
...
[Python](/v0.1/sdk/python/) and [TypeScript](/v0.1/sdk/typescript/) SDKs can
